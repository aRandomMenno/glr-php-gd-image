    ...
    <fieldset class="border p-3 rounded bg-light">
      ...
      <form method="post" action="upload.php" enctype="multipart/form-data">
        <div class="mb-2">
          ...
          <input type="text" class="form-control" name="name" id="name" value="Menno">
        </div>
        <div class="mb-2">
          <label for="title" class="form-label">What's the title:</label>
          <input type="text" class="form-control" name="title" id="title" value="flow">
        </div>
        <div class="mb-2">
          <label for="file" class="form-label">Upload a picture: (6MB max)</label>
